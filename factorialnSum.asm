...
# The program calculates the factorial of a number and the sum of factorials until 5.			
...
Main:		addi $v0, $zero, 4		# service 4 -> print string
			...
			jal Par					# Call the function with labe "Par"
